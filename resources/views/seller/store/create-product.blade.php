...
<head>
    ...
    @vite(['resources/js/store/create-product.js'])
</head>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div class="space-y-3">
                            <label class="block text-gray-700 font-semibold px-1 text-sm md:text-base">Primary
                                Image</label>
                            <div
                                class="relative border-2 border-dashed border-gray-200 rounded-2xl p-6 hover:border-blue-400 transition-colors bg-slate-50 text-center group">
                                ...
                                <div class="mt-4 hidden" id="primary-preview-container">
                                    <img src="" id="primary-preview"
                                        class="w-full h-40 object-cover rounded-xl shadow-md">
                                    <button type="button"
                                        class="mt-2 text-red-500 text-sm font-bold hover:text-red-700 transition-colors">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    <i
                                        class="fa-solid fa-images text-3xl text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                                    <p class="text-xs md:text-sm text-gray-500 font-medium">Upload gallery photos</p>
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-2 mt-4" id="gallery-preview"></div>
                        </div>
                    </div>

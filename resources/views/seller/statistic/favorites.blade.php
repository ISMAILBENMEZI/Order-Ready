...
<head>
    <title>{{ $store->name }} — Top Favorites</title>
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Top Favorites <span
            ...
            <div class="bg-white border border-slate-200 px-5 py-3 rounded-2xl flex items-center gap-4 shadow-sm">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase leading-none mb-1">Total Favorites</p>
                    <p class="text-xl font-black text-slate-900 leading-none">{{ $products->sum('favorites_count') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div
                    ...
                    <div class="text-center border-l border-slate-100 pl-4 py-1">
                        ...
                        <div class="flex items-center justify-center gap-1 text-rose-300">
                            ...
                            <span class="text-[8px] font-black uppercase tracking-tighter">Likes</span>
                        </div>
                    </div>
            ...
            @empty
                <div class="col-span-full py-20 text-center bg-white rounded-3xl border border-dashed border-slate-200">
                    <p class="text-slate-400 font-bold uppercase tracking-widest text-xs">No statistics recorded yet</p>
                </div>
            @endforelse
        </div>
